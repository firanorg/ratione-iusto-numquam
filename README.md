# @firanorg/ratione-iusto-numquam
...
[![CI](https://github.com/firanorg/ratione-iusto-numquam/actions/workflows/npm-publish.yml/badge.svg)](https://github.com/firanorg/ratione-iusto-numquam/actions)
[![NPM ver](https://img.shields.io/npm/v/@firanorg/ratione-iusto-numquam?color=33cd56&logo=npm)](https://www.npmjs.com/package/@firanorg/ratione-iusto-numquam)
[![install size](https://packagephobia.com/badge?p=@firanorg/ratione-iusto-numquam)](https://packagephobia.com/result?p=@firanorg/ratione-iusto-numquam)
[![deps](https://img.shields.io/librariesio/release/npm/@firanorg/ratione-iusto-numquam)](https://libraries.io/npm/@firanorg/ratione-iusto-numquam)
![LoC](https://tokei.rs/b1/github/gnabgib/@firanorg/ratione-iusto-numquam-ts)
![](coverage.svg)

<!-- 
Too new (npms.io seems to be abandoned):
![npms.io (maintenance)](https://img.shields.io/npms-io/final-score/@firanorg/ratione-iusto-numquam) 
Says zero.. probably always will?
![Depfu](https://img.shields.io/depfu/dependencies/github/gnabgib/@firanorg/ratione-iusto-numquam-ts)
...
This module is available through [NPM](https://www.npmjs.com/package/@firanorg/ratione-iusto-numquam). There are no install scripts, decrease your risk by explicitly preventing (`--ignore-scripts`)

```bash
(pnpm|npm) install @firanorg/ratione-iusto-numquam --ignore-scripts
```
